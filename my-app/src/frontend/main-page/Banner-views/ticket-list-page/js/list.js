...
filteredBugs.forEach(bug=>{
   ...
   +'<td class><a style="font-weight: 800;color: rgb(26, 43, 43);background: darkslategray;border-radius: 12px;text-decoration: none; -webkit-app-region: no-drag; border: 2px solid rgb(65, 109, 109);"href="../ticket-list-page/bug-details.html?bugId='+bug.id+'">See Details</a>';'</td>'
